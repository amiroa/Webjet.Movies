...
public class CinemaWorldClient : IProviderClient
{
    private readonly HttpClient _httpClient;
    private readonly ILogger<CinemaWorldClient> _logger;
        ...
        IOptions<CacheSettings> cacheSettings)
    {
        ...
        var config = providersConfig.Value.Cinemaworld;
